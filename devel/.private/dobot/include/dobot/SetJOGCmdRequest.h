...
bool operator==(const ::dobot::SetJOGCmdRequest_<ContainerAllocator1> & lhs, const ::dobot::SetJOGCmdRequest_<ContainerAllocator2> & rhs)
{
  return lhs.isJoint == rhs.isJoint &&
    lhs.cmd == rhs.cmd;
}
