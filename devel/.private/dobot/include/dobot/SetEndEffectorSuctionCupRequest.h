...
bool operator==(const ::dobot::SetEndEffectorSuctionCupRequest_<ContainerAllocator1> & lhs, const ::dobot::SetEndEffectorSuctionCupRequest_<ContainerAllocator2> & rhs)
{
