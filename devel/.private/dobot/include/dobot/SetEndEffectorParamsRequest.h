...
bool operator==(const ::dobot::SetEndEffectorParamsRequest_<ContainerAllocator1> & lhs, const ::dobot::SetEndEffectorParamsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.xBias == rhs.xBias &&
    lhs.yBias == rhs.yBias &&
    lhs.zBias == rhs.zBias &&
