...
bool operator==(const ::dobot::GetPTPJumpParamsResponse_<ContainerAllocator1> & lhs, const ::dobot::GetPTPJumpParamsResponse_<ContainerAllocator2> & rhs)
{
  return lhs.result == rhs.result &&
    lhs.jumpHeight == rhs.jumpHeight &&
