...
bool operator==(const ::dobot::GetEndEffectorSuctionCupResponse_<ContainerAllocator1> & lhs, const ::dobot::GetEndEffectorSuctionCupResponse_<ContainerAllocator2> & rhs)
{
