...
bool operator==(const ::dobot::GetInfraredSensorRequest_<ContainerAllocator1> & lhs, const ::dobot::GetInfraredSensorRequest_<ContainerAllocator2> & rhs)
{
  return lhs.infraredPort == rhs.infraredPort;
}
