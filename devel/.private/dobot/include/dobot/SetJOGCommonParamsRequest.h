...
bool operator==(const ::dobot::SetJOGCommonParamsRequest_<ContainerAllocator1> & lhs, const ::dobot::SetJOGCommonParamsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.velocityRatio == rhs.velocityRatio &&
    lhs.accelerationRatio == rhs.accelerationRatio &&
