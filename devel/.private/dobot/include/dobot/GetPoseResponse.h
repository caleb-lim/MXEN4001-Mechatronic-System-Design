...
struct GetPoseResponse_
{
  ...
  _r_type r;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _jointAngle_type;
...
bool operator==(const ::dobot::GetPoseResponse_<ContainerAllocator1> & lhs, const ::dobot::GetPoseResponse_<ContainerAllocator2> & rhs)
{
